...
export function DashboardStatsCards({
  ...
  return (
    <div className="dashboard-stats-cards">
      ...
      >
        <div style={{ background: '#232d3b', padding: '1rem 1.5rem', borderRadius: '0.625rem', border: '1px solid color-mix(in srgb, #ffc107 35%, #333)', boxShadow: '0 4px 12px rgba(0,0,0,0.25)' }}>
          <div style={{ fontSize: '0.75rem', textTransform: 'uppercase', color: '#ffc107', fontWeight: 700, marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
            <ListTodo size={14} style={{ color: '#ffc107' }} /> <Trans>Taken</Trans>
          </div>
          <div style={{ fontSize: '0.85rem', display: 'flex', flexDirection: 'column', gap: '0.3rem', color: '#fff' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}><span style={{ color: 'color-mix(in srgb, #fff 75%, transparent)' }}><Trans>Afgerond:</Trans></span> <strong style={{ color: '#ffc107' }}>{stats.tasksCompleted}</strong></div>
        ...
        <div style={{ background: '#232d3b', padding: '1rem 1.5rem', borderRadius: '0.625rem', border: '1px solid color-mix(in srgb, #ffc107 35%, #333)', boxShadow: '0 4px 12px rgba(0,0,0,0.25)' }}>
          <div style={{ fontSize: '0.75rem', textTransform: 'uppercase', color: '#ffc107', fontWeight: 700, marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
            <Timer size={14} style={{ color: '#ffc107' }} /> <Trans>Uren</Trans>
          </div>
          <div style={{ fontSize: '0.85rem', display: 'flex', flexDirection: 'column', gap: '0.3rem', color: '#fff' }}>
        ...
        <div style={{ background: '#232d3b', padding: '1rem 1.5rem', borderRadius: '0.625rem', border: '1px solid color-mix(in srgb, #ffc107 35%, #333)', boxShadow: '0 4px 12px rgba(0,0,0,0.25)' }}>
          <div style={{ fontSize: '0.75rem', textTransform: 'uppercase', color: '#ffc107', fontWeight: 700, marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
            <MessagesSquare size={14} style={{ color: '#ffc107' }} /> <Trans>Discussies</Trans>
          </div>
          <div style={{ fontSize: '0.85rem', display: 'flex', flexDirection: 'column', gap: '0.3rem', color: '#fff' }}>
        ...
        <div style={{ background: '#232d3b', padding: '1rem 1.5rem', borderRadius: '0.625rem', border: '1px solid color-mix(in srgb, #ffc107 35%, #333)', boxShadow: '0 4px 12px rgba(0,0,0,0.25)' }}>
          <div style={{ fontSize: '0.75rem', textTransform: 'uppercase', color: '#ffc107', fontWeight: 700, marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
            <FolderPlus size={14} style={{ color: '#ffc107' }} /> <Trans>Projecten</Trans>
          </div>
          <div style={{ fontSize: '0.85rem', display: 'flex', flexDirection: 'column', gap: '0.3rem', color: '#fff' }}>
