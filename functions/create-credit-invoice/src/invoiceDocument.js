...
/** Credit notes reverse the original invoice, so every amount is shown negated even
 * though the row itself stores positive magnitudes (see InvoiceRow.creditForInvoiceId). */
 ...
 */
export function buildCreditInvoiceDocument({ invoice, company, lines, settings, originalInvoiceNumber }) {
